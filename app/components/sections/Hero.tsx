        ...
        <div className='container mx-auto px-6 md:px-[140px] relative h-full'>
          ...
          <div className='md:hidden flex flex-col items-start pt-[80px]'>
            ...
            >
              ...
              <a href='#form' onClick={scrollToForm} className='w-full mb-8'>
                <Button className='w-full bg-[#14b8a6] hover:bg-[#0d9488] text-white px-6 py-3 rounded-sm flex items-center justify-center gap-3 transition-all text-sm'>
                  <svg
              ...
              <div key={setIndex} className='flex items-center'>
                {marqueeItems.map((text, index) => (
                  <div key={index} className='flex items-center'>
                    <span className='text-[32px] md:text-[64px] font-bold tracking-tighter text-white/30 px-6 md:px-12'>
                      {text}
                    </span>
